...
func (d *PredictControl) GetBelongs(c *gin.Context) {
	d.Response(c, BelongList, nil)
}

func (d *PredictControl) GetLocations(c *gin.Context) {
	d.Response(c, LocationList, nil)
}

...
func (mc *mysqlConn) Begin() (rtx driver.Tx, txerr error) {
	return mc.beginToutiao(context.Background())
}
...
func (mc *mysqlConn) beginToutiao(ctx context.Context) (rtx driver.Tx, txerr error) {
	...
	// Interpolate PSM
	err := mc.exec(interpolatePSM("START TRANSACTION"))
	if err == nil {
...
func (mc *mysqlConn) Prepare(query string) (rstmt driver.Stmt, perr error) {
	return mc.prepareToutiao(context.Background(), query)
}
...
func (mc *mysqlConn) Exec(query string, args []driver.Value) (result driver.Result, exerr error) {
	return mc.execToutiao(context.Background(), query, args)
}
...
func (mc *mysqlConn) Query(query string, args []driver.Value) (driver.Rows, error) {
	return mc.queryToutiao(context.Background(), query, args)
}

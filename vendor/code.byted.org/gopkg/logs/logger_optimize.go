...
func (l *Logger) Fatalsf(format string, v ...string) {
	...
	if len(v) == 0 {
		l.fmtLog(nil, LevelFatal, "", format)
		return
	}
	l.fmtLog(nil, LevelFatal, "", utils.Sprintf(format, v...))
}
...
func (l *Logger) Errorsf(format string, v ...string) {
	...
	if len(v) == 0 {
		l.fmtLog(nil, LevelError, "", format)
		return
	}
	l.fmtLog(nil, LevelError, "", utils.Sprintf(format, v...))
}
...
func (l *Logger) Warnsf(format string, v ...string) {
	...
	if len(v) == 0 {
		l.fmtLog(nil, LevelWarn, "", format)
		return
	}
	l.fmtLog(nil, LevelWarn, "", utils.Sprintf(format, v...))
}
...
func (l *Logger) Noticesf(format string, v ...string) {
	...
	if len(v) == 0 {
		l.fmtLog(nil, LevelNotice, "", format)
		return
	}
	l.fmtLog(nil, LevelNotice, "", utils.Sprintf(format, v...))
}
...
func (l *Logger) Infosf(format string, v ...string) {
	...
	if len(v) == 0 {
		l.fmtLog(nil, LevelInfo, "", format)
		return
	}
	l.fmtLog(nil, LevelInfo, "", utils.Sprintf(format, v...))
}
...
func (l *Logger) Debugsf(format string, v ...string) {
	...
	if len(v) == 0 {
		l.fmtLog(nil, LevelDebug, "", format)
		return
	}
	l.fmtLog(nil, LevelDebug, "", utils.Sprintf(format, v...))
}
...
func (l *Logger) Tracesf(format string, v ...string) {
	...
	if len(v) == 0 {
		l.fmtLog(nil, LevelTrace, "", format)
		return
	}
	l.fmtLog(nil, LevelTrace, "", utils.Sprintf(format, v...))
}
...
func (l *Logger) Fatalfl(fileLocation string, format string, v ...interface{}) {
	...
	if len(v) == 0 {
		l.fmtLog(nil, LevelFatal, fileLocation, format)
		return
	}
	l.fmtLog(nil, LevelFatal, fileLocation, fmt.Sprintf(format, v...))
}
...
func (l *Logger) Errorfl(fileLocation string, format string, v ...interface{}) {
	...
	if len(v) == 0 {
		l.fmtLog(nil, LevelError, fileLocation, format)
		return
	}
	l.fmtLog(nil, LevelError, fileLocation, fmt.Sprintf(format, v...))
}
...
func (l *Logger) Warnfl(fileLocation string, format string, v ...interface{}) {
	...
	if len(v) == 0 {
		l.fmtLog(nil, LevelWarn, fileLocation, format)
		return
	}
	l.fmtLog(nil, LevelWarn, fileLocation, fmt.Sprintf(format, v...))
}
...
func (l *Logger) Noticefl(fileLocation string, format string, v ...interface{}) {
	...
	if len(v) == 0 {
		l.fmtLog(nil, LevelNotice, fileLocation, format)
		return
	}
	l.fmtLog(nil, LevelNotice, fileLocation, fmt.Sprintf(format, v...))
}
...
func (l *Logger) Infofl(fileLocation string, format string, v ...interface{}) {
	...
	if len(v) == 0 {
		l.fmtLog(nil, LevelInfo, fileLocation, format)
		return
	}
	l.fmtLog(nil, LevelInfo, fileLocation, fmt.Sprintf(format, v...))
}
...
func (l *Logger) Debugfl(fileLocation string, format string, v ...interface{}) {
	...
	if len(v) == 0 {
		l.fmtLog(nil, LevelDebug, fileLocation, format)
		return
	}
	l.fmtLog(nil, LevelDebug, fileLocation, fmt.Sprintf(format, v...))
}
...
func (l *Logger) Tracefl(fileLocation string, format string, v ...interface{}) {
	...
	if len(v) == 0 {
		l.fmtLog(nil, LevelTrace, fileLocation, format)
		return
	}
	l.fmtLog(nil, LevelTrace, fileLocation, fmt.Sprintf(format, v...))
}
...
func (l *Logger) Fatalsffl(fileLocation string, format string, v ...string) {
	...
	l.fmtLog(nil, LevelFatal, fileLocation, utils.Sprintf(format, v...))
}
...
func (l *Logger) Errorsffl(fileLocation string, format string, v ...string) {
	...
	l.fmtLog(nil, LevelError, fileLocation, utils.Sprintf(format, v...))
}
...
func (l *Logger) Warnsffl(fileLocation string, format string, v ...string) {
	...
	l.fmtLog(nil, LevelWarn, fileLocation, utils.Sprintf(format, v...))
}
...
func (l *Logger) Noticesffl(fileLocation string, format string, v ...string) {
	...
	l.fmtLog(nil, LevelNotice, fileLocation, utils.Sprintf(format, v...))
}
...
func (l *Logger) Infosffl(fileLocation string, format string, v ...string) {
	...
	l.fmtLog(nil, LevelInfo, fileLocation, utils.Sprintf(format, v...))
}
...
func (l *Logger) Debugsffl(fileLocation string, format string, v ...string) {
	...
	l.fmtLog(nil, LevelDebug, fileLocation, utils.Sprintf(format, v...))
}
...
func (l *Logger) Tracesffl(fileLocation string, format string, v ...string) {
	...
	l.fmtLog(nil, LevelTrace, fileLocation, utils.Sprintf(format, v...))
}

...
func ParseErrorReply(line []byte) error {
	return pkg.RedisError(string(line[1:]))
}
...
func atoi(b []byte) (int, error) {
	return strconv.Atoi(pkg.BytesToString(b))
}

func parseInt(b []byte, base int, bitSize int) (int64, error) {
	return strconv.ParseInt(pkg.BytesToString(b), base, bitSize)
}

func parseUint(b []byte, base int, bitSize int) (uint64, error) {
	return strconv.ParseUint(pkg.BytesToString(b), base, bitSize)
}

func parseFloat(b []byte, bitSize int) (float64, error) {
	return strconv.ParseFloat(pkg.BytesToString(b), bitSize)
}

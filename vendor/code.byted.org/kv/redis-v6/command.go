...
func (cmd *StringCmd) Val() string {
	return pkg.BytesToString(cmd.val)
}
...
func NewXGetCmd(args ...interface{}) *XGetCmd {
	return &XGetCmd{
		baseCmd: baseCmd{_args: args},
	}
}

func (cmd *XGetCmd) Val() (interface{}, int64) {
	return cmd.val, cmd.generation
}

func (cmd *XGetCmd) Result() (interface{}, int64, error) {
	return cmd.val, cmd.generation, cmd.err
}

func (cmd *XGetCmd) String() string {
	return cmdString(cmd, cmd.val)
}

func (cmd *XGetCmd) readReply(cn *pool.Conn) error {
	var v interface{}
	v, cmd.err = cn.Rd.ReadArrayReply(sliceParser)
	if cmd.err != nil {
		return cmd.err
	...
	arr := v.([]interface{})
	if len(arr) != 2 {
		return fmt.Errorf("Invalid number of slices")
	}
	cmd.val = arr[0]
	cmd.generation = arr[1].(int64)
	return nil
}
...
func NewXSetCmd(args ...interface{}) *XSetCmd {
	return &XSetCmd{
		baseCmd: baseCmd{_args: args},
	}
}

func (cmd *XSetCmd) Val() (int64, interface{}, int64) {
	return cmd.numOps, cmd.val, cmd.generation
}

func (cmd *XSetCmd) Result() (int64, interface{}, int64, error) {
	return cmd.numOps, cmd.val, cmd.generation, cmd.err
}

func (cmd *XSetCmd) String() string {
	return cmdString(cmd, cmd.val)
}

func (cmd *XSetCmd) readReply(cn *pool.Conn) error {
	var v interface{}
	v, cmd.err = cn.Rd.ReadArrayReply(sliceParser)
	if cmd.err != nil {
		return cmd.err
	...
	cmd.numOps = arr[0].(int64)
	cmd.val = arr[1]
	cmd.generation = arr[2].(int64)
	return nil
}

//------------------------------------------------------------------------------

type ScanRowCmd struct {
	baseCmd

	val interface{}
}

func NewScanRowCmd(args ...interface{}) *ScanRowCmd {
	return &ScanRowCmd{
		baseCmd: baseCmd{_args: args},
	}
}

func (cmd *ScanRowCmd) Val() interface{} {
	return cmd.val
}

func (cmd *ScanRowCmd) Result() (interface{}, error) {
	return cmd.val, cmd.err
}

func (cmd *ScanRowCmd) String() string {
	return cmdString(cmd, cmd.val)
}

func (cmd *ScanRowCmd) readReply(cn *pool.Conn) error {
	cmd.val, cmd.err = cn.Rd.ReadArrayReply(byteSliceParser)
	return cmd.err
}

type TtlQScanCmd struct {
	baseCmd

	val interface{}
}

func NewTtlQScanCmd(args ...interface{}) *TtlQScanCmd {
	return &TtlQScanCmd{
		baseCmd: baseCmd{_args: args},
	}
}

func (cmd *TtlQScanCmd) Val() interface{} {
	return cmd.val
}

func (cmd *TtlQScanCmd) Result() (interface{}, error) {
	return cmd.val, cmd.err
}

func (cmd *TtlQScanCmd) String() string {
	return cmdString(cmd, cmd.val)
}

func (cmd *TtlQScanCmd) readReply(cn *pool.Conn) error {
	cmd.val, cmd.err = cn.Rd.ReadArrayReply(ttlQItemParser)
	return cmd.err
}
